...
- Added automatic unlocks for **pistol ↔ handgun** conversion recipes for Classfixes Part 1.
- Added automatic unlocks for **knife ↔ dagger** conversion recipes for Knives Master.
